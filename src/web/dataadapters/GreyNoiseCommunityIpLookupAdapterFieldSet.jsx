...
const GreyNoiseCommunityIpLookupAdapterFieldSet = ({ config, updateConfig, validationMessage, validationState }) => {
...
GreyNoiseCommunityIpLookupAdapterFieldSet.propTypes = {
...
export default GreyNoiseCommunityIpLookupAdapterFieldSet;
