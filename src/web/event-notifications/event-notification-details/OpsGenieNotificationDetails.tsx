...
const OpsGenieNotificationDetails: React.FC<OpsGenieNotificationSummaryType> = ({ notification }) => (
  <>
    <ReadOnlyFormGroup label="API Access Token" value={notification.config.access_token} />
    ...
    <ReadOnlyFormGroup label="Custom Message Template "
        ...
        <ReadOnlyFormGroup label="Main Fields Template "
                           value={(
                             <NewExampleWell bsSize="small">
                               {notification.config.main_fields || <em>Empty body</em>}
                             </NewExampleWell>
                           )} />
    ...
    <ReadOnlyFormGroup label="Tags" value={notification.config.tags} />
  </>
);

// OpsGenieNotificationDetails.propTypes = {
//   notification: PropTypes.object.isRequired,
// };

export default OpsGenieNotificationDetails;
