...
public class OpsGenieEventNotificationTest {

    //code under test
    OpsGenieEventNotification OpsGenieEventNotification;
    ...
    @Mock
    OpsGenieClient mockrequestClient;

    @Mock
    EventNotificationService notificationCallbackService;


    private OpsGenieEventNotificationConfig osGenieEventNotificationConfig;
    ...
    public void setUp() {
        ...
        getDummyOpsGenieNotificationConfig();
        eventNotificationContext = NotificationTestData.getDummyContext(getHttpNotification(), "ayirp").toBuilder().notificationConfig(osGenieEventNotificationConfig).build();
        ...
        OpsGenieEventNotification = new OpsGenieEventNotification(notificationCallbackService, new ObjectMapperProvider().get(),
                Engine.createEngine(),
    ...
    private void getDummyOpsGenieNotificationConfig() {
        osGenieEventNotificationConfig = new AutoValue_OpsGenieEventNotificationConfig.Builder()
                .type(OpsGenieEventNotificationConfig.TYPE_NAME)
                .accessToken("axzzzz")
                .backlogSize(1)
                .tags("tags")
                .channel("team")
    ...
    @Test
    public void createOpsGenieMessage() throws EventNotificationException {
        String expected = "{\"description\":\"_Event Definition Test Description_\",\"details\":{\"a custom message\":\"\"},\"message\":\"_Event Definition Test Title_\",\"priority\":\"P2\",\"user\":null,\"responders\":[{\"type\":\"team\",\"name\":\"team\"}],\"tags\":[\"tags\"]}";
        OpsGenieMessage message = OpsGenieEventNotification.createOpsGenieMessage(eventNotificationContext, osGenieEventNotificationConfig);
    ...
    public void tearDown() {
        OpsGenieEventNotification = null;
        osGenieEventNotificationConfig = null;
        eventNotificationContext = null;
    }

    @Test
    public void buildDefaultMessage() {
        String message = OpsGenieEventNotification.buildDefaultMessage(eventNotificationContext);
    ...
    public void getCustomMessageModel() {
        ...
        Map<String, Object> customMessageModel = OpsGenieEventNotification.getCustomMessageModel(eventNotificationContext, osGenieEventNotificationConfig.type(), messageSummaries);
        ...
        assertThat(customMessageModel.get("type")).isEqualTo("opsgenie-notification-v1");
    ...
    public void execute_with_invalid_webhook_url() throws EventNotificationException {
        ...
        givenGoodNodeId();
        givenOpsGenieClientThrowsPermException();
        //when execute is called with a invalid webhook URL, we expect a event notification exception
        OpsGenieEventNotification.execute(eventNotificationContext);
    }
    ...
    public void execute_with_null_event_timerange() throws EventNotificationException {
        ...
        assertThat(yetAnotherContext.notificationConfig().type()).isEqualTo(OpsGenieEventNotificationConfig.TYPE_NAME);
        OpsGenieEventNotification.execute(yetAnotherContext);
    }
    ...
    private EventNotificationContext getEventNotificationContextToSimulateNullPointerException() {
        ...
        return EventNotificationContext.builder()
                .notificationId("1234")
                .notificationConfig(osGenieEventNotificationConfig)
                .event(eventDto)
    ...
    private void givenOpsGenieClientThrowsPermException() throws TemporaryEventNotificationException, PermanentEventNotificationException {
    ...
    public void buildCustomMessage() throws PermanentEventNotificationException {
        Map<String, String> expectedCustomMessage = OpsGenieEventNotification.buildCustomMessage(eventNotificationContext, osGenieEventNotificationConfig, "test");
    ...
    public void buildCustomMessage_with_invalidTemplate() throws EventNotificationException {
        osGenieEventNotificationConfig = buildInvalidTemplate();
        OpsGenieEventNotification.buildCustomMessage(eventNotificationContext, osGenieEventNotificationConfig, "Title:       ${does't exist}");
    }
    ...
    public void test_customMessage() throws PermanentEventNotificationException {
        ...
        OpsGenieEventNotificationConfig OpsGenieConfig = OpsGenieEventNotificationConfig.builder()
                .backlogSize(5)
                .mainFields("alert")
                .build();
        Map<String, String> message = OpsGenieEventNotification.buildCustomMessage(eventNotificationContext, OpsGenieConfig, "Title:       ${event_definition_title}");
        Map<String, String> fact = new HashMap<>();
        fact.put("Title", "Event Definition Test Title");

        assertThat(message).isEqualTo(fact);
    }
    ...
    public void test_backlog_message_limit_when_backlogSize_isFive() {
        ...
        List<MessageSummary> messageSummaries = OpsGenieEventNotification.getMessageBacklog(eventNotificationContext, OpsGenieConfig);
    ...
    public void test_backlog_message_limit_When_eventNotificationContext_isNull() {
        ...
        List<MessageSummary> messageSummaries = OpsGenieEventNotification.getMessageBacklog(null, OpsGenieConfig);
    ...
    OpsGenieEventNotificationConfig buildInvalidTemplate() {
        OpsGenieEventNotificationConfig.Builder builder = new AutoValue_OpsGenieEventNotificationConfig.Builder().create();
        builder.customMessage("Title").mainFields("alert message");
